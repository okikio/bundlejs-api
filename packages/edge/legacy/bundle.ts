...
import type { BundleModule, Config } from "./types.ts";
...
export async function bundle(url: URL, initialValue: string, configObj: Config, versions: string[], modules: BundleModule[], query: string) {
