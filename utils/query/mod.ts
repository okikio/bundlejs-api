 ...
 *
 * import { createEndpoindQuerySpec } from './schemas.ts'
 * import { createValidator } from '@utils/middleware/validation' // your existing middleware factory
 * 
 * import { executeCollectionQuery } from '@utils/execution'
 * import { paginate, gone, badRequest } from '#shared/utils/response/mod.ts'
 *
 ...
 *
 *   const result = await executeCollectionQuery(db, 'user', spec)
 *
